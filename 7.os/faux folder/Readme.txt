This Portable Version was completely made by Bernhard E. (Berny23). 
...
USER CONFIGURATION (Outdated!)
==================

Some configuration in the PortableApps.com Launcher can be overridden by the
user in an INI file next to pycharm.exe called idea.properties.
...
copy AppNamePortable.ini from this directory to idea.properties next to
pycharm.exe. The options in the INI file are as follows:
